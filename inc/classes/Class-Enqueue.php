...
class Magazine_Enqueue {

	public $scripts = array();

	public function magazine_scripts_enqueue_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'magazine_frontend_enqueue_scripts', ) );
	}

	public function magazine_frontend_enqueue_scripts( ) {
