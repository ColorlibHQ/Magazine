...
class Magazine_popular_post_widget extends WP_Widget {

	function __construct() {

		parent::__construct(
			// Base ID of your widget
			'magazine_popular_post_widget',


			// Widget name will appear in UI
			esc_html__( '[ Magazine ] Popular Post', 'magazine' ),

			// Widget description
			array( 'description' => esc_html__( 'Add popular post with thumbnail', 'magazine' ), )
		);
	...
	public function form( $instance ) {
		...
		if ( isset( $instance[ 'title' ] ) ) {
			...
			$title = esc_html__( 'Most Popular', 'magazine' );
		}
		//	
...
function magazine_popular_post_load_widget() {
	register_widget( 'Magazine_popular_post_widget' );
}
add_action( 'widgets_init', 'magazine_popular_post_load_widget' );