...
// image default alt
if( ! function_exists( 'magazine_img_default_alt' ) ) {
	function magazine_img_default_alt( $url = '' ) {
...
// Image Tag
if( ! function_exists( 'magazine_img_tag' ) ) {
	function magazine_img_tag( array $args ) {
		...
		if( ! empty( $args['alt'] ) ) {
			...
			$alt = magazine_img_default_alt( $url );
		}
...
// Anchor Tag
if( ! function_exists( 'magazine_anchor_tag' ) ) {
	function magazine_anchor_tag( array $args ) {
		
		$default = array(
			'url' 	 		=> '',
			'text' 	 		=> esc_html__( 'Click Here', 'magazine' ),
			'target' 		=> '',
			'title' 		=> '',
			'class'  		=> '',
			'id' 	 		=> '',
...
// Heading Tag
if( ! function_exists( 'magazine_heading_tag' ) ) {
	function magazine_heading_tag( array $args ) {
		
		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => esc_html__( 'Write Something', 'magazine' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
			'wrap_after'  => '',
...
// Paragraph Tag
if( ! function_exists( 'magazine_paragraph_tag' ) ) {
	function magazine_paragraph_tag( array $args ) {
...
// Other Tag
if( ! function_exists( 'magazine_other_tag' ) ) {
	function magazine_other_tag( array $args ) {
...
// Button Element 
if( ! function_exists( 'magazine_button_element ' ) ) {
	function magazine_button_element( array $args ) {
		
		$default = array(
			'text' 	 	  => esc_html__( 'Button', 'magazine' ),
			'type'   	  => '',
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
